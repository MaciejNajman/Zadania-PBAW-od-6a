...
function &getSmarty(){
	...
	if (!isset($smarty)){
		//stwórz Smarty
		include_once 'lib/smarty/Smarty.class.php';//nie dzialala sciezka wzgledna, ale dziala sciezka D:\xampp\htdocs\kalk_kredytowy_ochrona_dostepu\lib\smarty\Smarty.class.php', możliwy powód: \ zamiast /
		$smarty = new Smarty();
