...
class LoginCtrl{
	...
	public function validate() {
		...
		if ( !getMessages()->isError() ) {
			...
			if ($this->form->login == "admin" && $this->form->pass == "admin") {
				...
				//zapisz od razu cały obiekt w sesji, ale trzeba go zserializować
				...
				// zapisz obiekt użytkownika w sesji, po serializacji
				$_SESSION['user'] = serialize($user);
				// dodaj rolę użytkownikowi (jak wiemy, zapisane też w sesji)
				addRole($user->role);
	...
	public function generateView(){
		...
		getSmarty()->assign('page_title','Strona logowania do kalkulatora kredytowego');
